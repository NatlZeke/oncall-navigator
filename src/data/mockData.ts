...
// Seed Data for Demo - Hill Country Eye Center
export const mockCompany: Company = {
  id: 'company-1',
  name: 'Hill Country Eye Center',
...
export const mockOffices: Office[] = [
  {
    ...
    name: 'Cedar Park Main Office',
    timezone: 'America/Chicago',
    phone_main: '(512) 528-1144',
  ...
  },
  {
    id: 'office-2',
    company_id: 'company-1',
    name: 'Georgetown Office',
    timezone: 'America/Chicago',
    phone_main: '(512) 528-1155',
...
export const mockUsers: User[] = [
  ...
  {
    id: 'user-1',
    email: 'dr.restivo@hillcountryeye.com',
    full_name: 'Dr. Vincent A. Restivo, M.D.',
    phone_mobile: '(512) 555-1001',
    created_at: '2024-01-01T00:00:00Z',
  },
  {
    id: 'user-2',
    email: 'dr.shepler@hillcountryeye.com',
    full_name: 'Dr. Todd R. Shepler, M.D.',
    phone_mobile: '(512) 555-1002',
    created_at: '2024-01-01T00:00:00Z',
  },
  {
    id: 'user-3',
    email: 'dr.osterman@hillcountryeye.com',
    full_name: 'Dr. Nathan E. Osterman, O.D.',
    phone_mobile: '(512) 555-1003',
    created_at: '2024-01-01T00:00:00Z',
  },
  {
    id: 'user-4',
    email: 'dr.devitt@hillcountryeye.com',
    full_name: 'Dr. Chelsea Devitt, O.D., FAAO',
    phone_mobile: '(512) 555-1004',
    created_at: '2024-01-15T00:00:00Z',
  },
  // Additional staff
  {
    id: 'user-5',
    email: 'scheduler@hillcountryeye.com',
    full_name: 'Rachel Leon',
    phone_mobile: '(512) 555-2001',
    created_at: '2024-01-01T00:00:00Z',
  },
  {
    id: 'user-6',
    email: 'admin@hillcountryeye.com',
    full_name: 'Maria Santos',
    phone_mobile: '(512) 555-3001',
    created_at: '2024-01-01T00:00:00Z',
  },
  {
    id: 'user-7',
    email: 'operator@hillcountryeye.com',
    full_name: 'James Wilson',
    phone_mobile: '(512) 555-4001',
    created_at: '2024-01-01T00:00:00Z',
  },
];
...
export const mockShifts: OnCallShift[] = [
  // Cedar Park Office - Today - Cataract Surgery
  {
    id: 'shift-1',
    office_id: 'office-1',
  ...
  // Cedar Park Office - Today - Glaucoma
  {
    id: 'shift-2',
    office_id: 'office-1',
    ...
    backup_provider_user_id: 'user-4',
    status: 'published',
    created_by_user_id: 'user-5',
    created_at: '2024-01-01T00:00:00Z',
    updated_at: '2024-01-01T00:00:00Z',
  },
  // Cedar Park Office - Today - Oculoplastics
  {
    id: 'shift-3',
    office_id: 'office-1',
...
export const mockEscalationPaths: EscalationPath[] = [
  {
    ...
    tier3_contact: 'Office Manager: (512) 555-3001',
    method: 'call',
  ...
  },
  {
    ...
    tier1_contact: 'Primary On-Call Provider',
    tier2_contact: 'Backup On-Call Provider',
    tier3_contact: 'Dr. Restivo (Medical Director): (512) 555-1001',
    method: 'call',
  ...
  },
  {
    ...
    office_id: 'office-1',
    service_line_id: 'sl-3',
    tier1_contact: 'Dr. Shepler',
    tier2_contact: 'Dr. Restivo',
    tier3_contact: 'Office Manager: (512) 555-3001',
    method: 'call',
...
export const mockMemberships: Membership[] = [
  // Company level
  { id: 'm-1', user_id: 'user-6', company_id: 'company-1', role: 'company_owner', status: 'active', created_at: '2024-01-01T00:00:00Z' },
  // Cedar Park Office - Providers
  ...
  { id: 'm-5', user_id: 'user-4', office_id: 'office-1', role: 'provider', status: 'active', created_at: '2024-01-01T00:00:00Z' },
  // Cedar Park Office - Staff
  { id: 'm-6', user_id: 'user-5', office_id: 'office-1', role: 'scheduler', status: 'active', created_at: '2024-01-01T00:00:00Z' },
  { id: 'm-7', user_id: 'user-7', office_id: 'office-1', role: 'operator_readonly', status: 'active', created_at: '2024-01-01T00:00:00Z' },
  // Georgetown Office - Providers (cross-coverage)
  { id: 'm-8', user_id: 'user-1', office_id: 'office-2', role: 'provider', status: 'active', created_at: '2024-01-15T00:00:00Z' },
  { id: 'm-9', user_id: 'user-3', office_id: 'office-2', role: 'provider', status: 'active', created_at: '2024-01-15T00:00:00Z' },
  { id: 'm-10', user_id: 'user-4', office_id: 'office-2', role: 'provider', status: 'active', created_at: '2024-01-15T00:00:00Z' },
  { id: 'm-11', user_id: 'user-5', office_id: 'office-2', role: 'scheduler', status: 'active', created_at: '2024-01-15T00:00:00Z' },
  { id: 'm-12', user_id: 'user-7', office_id: 'office-2', role: 'operator_readonly', status: 'active', created_at: '2024-01-15T00:00:00Z' },
];
